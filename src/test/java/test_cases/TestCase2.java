...
public class TestCase2 extends BaseTest {
    ...
    public void test(String textFromParentFrame, String textFromChildFrame) {
        Logger.info("Test Case 2: Шаг 1. Перейти на главную страницу");
        MainPage mainPage = new MainPage();
        Assert.assertTrue(mainPage.isPageOpen(), "Main page is not open");

        Logger.info("Test Case 2: Шаг 2. Кликнуть на кнопку Alerts, Frame & Windows. На открывшейся странице в левом меню кликнуть пункт Nested Frames");
        ...
        Logger.info("Test Case 2: Шаг 3. В левом меню выбрать пункт Frames");
