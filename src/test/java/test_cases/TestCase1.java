...
public class TestCase1 extends BaseTest {
    ...
    public void test(String textSimpleAlert, String textConfirmAlert, String textResultConfirmAlert, String textPromptAlert) {
        Log.info("Test Case 1: Шаг 1. Перейти на главную страницу");
        MainPage mainPage = new MainPage();
        Assert.assertTrue(mainPage.isPageOpen(), "Main page is not open");

        Log.info("Test Case 1: Шаг 2. Кликнуть на кнопку Alerts, Frame & Windows. На открывшейся странице в левом меню кликнуть пункт Alerts");
        ...
        Log.info("Test Case 1: Шаг 3. Нажать на кнопку Click Button to see alert");
        ...
        Log.info("Test Case 1: Шаг 4. Нажать на кнопку OK");
        AlertUtil.clickAccept();
        Assert.assertFalse(AlertUtil.checkAlert(), "Alert is not closed");

        Log.info("Test Case 1: Шаг 5. Нажать на кнопку On button click, confirm box will appear");
        ...
        Log.info("Test Case 1: Шаг 6. Нажать на кнопку OK");
        AlertUtil.clickAccept();
        Assert.assertFalse(AlertUtil.checkAlert(), "Alert is not closed");
        Assert.assertEquals(alertsPage.getTextConfirmResult(), textResultConfirmAlert,
                "Text confirm result is not equals");

        Log.info("Test Case 1: Шаг 7. Нажать на кнопку On button click, prompt box will appear");
        ...
        Log.info("Test Case 1: Шаг 8. Ввести случайно сгенерированный текст, нажать на кнопку OK");
