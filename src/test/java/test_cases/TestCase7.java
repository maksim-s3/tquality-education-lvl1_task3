...
public class TestCase7 extends BaseTest {
    @Test
    public void test() {
        Logger.info("Test Case 7: Шаг 1. Перейти на главную страницу");
        MainPage mainPage = new MainPage();
        Assert.assertTrue(mainPage.isPageOpen(), "Main page is not open");

        Logger.info("Test Case 7: Шаг 2. Кликнуть на кнопку Elements. На открывшейся странице в левом меню кликнуть пункт Upload and Download");
        ...
        Logger.info("Test Case 7: Шаг 3. Нажать на кнопку Download, дождаться загрузки файла");
